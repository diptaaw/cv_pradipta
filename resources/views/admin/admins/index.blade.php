                        ...
                        <tr>
                            <td>
                                <div class="cms-avatar-cell">
                                    <img src="{{ $admin->avatar ? Storage::disk(config('filesystems.default'))->url(str_starts_with($admin->avatar, 'storage/') ? substr($admin->avatar, 8) : $admin->avatar) : asset('images/ui/avatar.png') }}" alt="{{ $admin->name }} avatar">
