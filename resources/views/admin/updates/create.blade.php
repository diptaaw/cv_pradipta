...
@section('breadcrumb')
    ...
    <span>&rarr;</span> <span class="active">New Update</span>
@endsection
        ...
        <div class="cms-form-grid" style="grid-template-columns: 1.2fr 1fr; gap: 24px;">
            ...
            <div class="admin-card cms-card-section">
                ...
                <div class="cms-form-group">
                    ...
                    <input class="cms-input" id="date" type="text" name="date" value="{{ old('date') }}" required placeholder="e.g. June 2026">
                </div>

                <div class="cms-form-group">
                    <label for="description">Short Description / Summary</label>
                    <textarea class="cms-textarea" id="description" name="description" rows="5" required placeholder="e.g. New Unity project featuring dynamic weather, NPC systems and wildlife interactions." style="min-height: 120px;">{{ old('description') }}</textarea>
                </div>
            </div>
            ...
            <div class="admin-card cms-card-section" style="display: flex; flex-direction: column; justify-content: space-between;">
                <div>
                    ...
                    <div class="cms-form-group" style="margin-bottom: 20px;">
                        <label style="display: flex; align-items: center; gap: 10px; cursor: pointer; user-select: none;">
                            <input type="checkbox" name="is_published" value="1" {{ old('is_published', true) ? 'checked' : '' }} style="width: 18px; height: 18px; accent-color: #7b61ff;">
                            <span style="font-size: 0.95rem; font-weight: 500;">Publish immediately</span>
                        </label>
                        <p style="font-size: 0.8rem; color: rgba(255,255,255,0.4); margin-left: 28px; margin-top: 4px;">
                ...
                <div class="form-actions" style="margin-top: 24px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.06); display: flex; justify-content: flex-end; gap: 12px;">
                    ...
                    <button type="submit" class="btn-primary-cms">Save Update</button>
                </div>
            </div>
        </div>
    </form>
