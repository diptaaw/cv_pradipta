            ...
            <header class="admin-topbar">
                ...
                <div class="topbar-right">
                    ...
                    <div class="profile-widget">
                        <img src="{{ auth()->user() && auth()->user()->avatar ? Storage::disk(config('filesystems.default'))->url(str_starts_with(auth()->user()->avatar, 'storage/') ? substr(auth()->user()->avatar, 8) : auth()->user()->avatar) : asset('images/ui/avatar.png') }}" alt="Admin Avatar">
