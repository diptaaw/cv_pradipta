            ...
            <div class="admin-card cms-card-section">
                ...
                <div class="cms-form-group">
                    ...
                    <div style="display: flex; align-items: center; gap: 16px; background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 12px;">
                        <img id="photo-preview" src="{{ $about->profile_image ? Storage::disk(config('filesystems.default'))->url(str_starts_with($about->profile_image, 'storage/') ? substr($about->profile_image, 8) : $about->profile_image) : asset('images/ui/avatar.png') }}" alt="Profile Image" style="width: 64px; height: 64px; border-radius: 12px; object-fit: cover; border: 1px solid rgba(255,255,255,0.1);">
                        <div>
